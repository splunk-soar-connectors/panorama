...
from panorama_consts import (BLOCK_URL_PROF_NAME, DEL_URL_CATEGORY_XPATH, DEL_URL_XPATH, MAX_NODE_NAME_LEN, PAN_ERROR_MESSAGE,
                             PAN_JSON_DEVICE_GRP, PAN_JSON_URL, URL_CATEGORY_XPATH, URL_PROF_XPATH)
...
class UnblockUrl(BaseAction):
    ...
    def _unblock_url_8_and_below(self, connector, action_result):
        ...
        xpath = "{0}{1}".format(
            URL_PROF_XPATH.format(config_xpath=connector.util._get_config_xpath(self._param), url_profile_name=url_prof_name),
    ...
    def _unblock_url_9_and_above(self, connector, action_result):
        ...
        xpath = "{0}{1}".format(
            URL_CATEGORY_XPATH.format(config_xpath=connector.util._get_config_xpath(self._param), url_profile_name=url_prof_name),
