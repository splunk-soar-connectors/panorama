...
class BlockApplication(BaseAction):
    def execute(self, connector):
        ...
        app_group_name = consts.BLOCK_APP_GROUP_NAME.format(device_group=self._param[consts.PAN_JSON_DEVICE_GRP])
        ...
        data = {
            ...
            "xpath": consts.APP_GRP_XPATH.format(config_xpath=connector.util._get_config_xpath(self._param), app_group_name=app_group_name),
